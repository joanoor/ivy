...
import useQueryTable, { defineQueryOption } from '@/hooks/web/ddddd'
import type {
  Result,
...
const { request, hookOption } = defineQueryOption(getAllMeterPage, {
  appendColumns: [
    {
      name: 'operate',
      title: '操作',
...
type C = ReturnType<typeof request>
const {
  tableData,
  tableColumns,
  columns,
  ...
  ReturnType<typeof request> extends Promise<
    Result<ResultPagingData<infer Struct>>
  >
    ? Struct
    : never
>(getAllMeterPage, {

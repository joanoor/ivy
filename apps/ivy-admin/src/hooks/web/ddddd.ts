...
export function defineQueryOption<T extends AnyFunction, QueryParams>(
  request: T,
  hookOption: HookOption<QueryParams>
) {
  type ResultTmp = ReturnType<typeof request> extends Promise<

...
type AxisTickOption2 = XAXisComponentOption['axisTick']
type AxisLineOption2 = XAXisComponentOption['axisLine']
type AxisLabelOption2 = XAXisComponentOption['axisLabel']
type SplitLineOption2 = XAXisComponentOption['splitLine']
type SplitAreaOption2 = XAXisComponentOption['splitArea']
...
export const getDefaultChartOpt = (option: EChartsOption, type: ChartType) =>
  merge(option, allChartOpt[type])
